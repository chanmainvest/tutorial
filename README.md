...
| 4 | [The 60/40 Portfolio](course/week04_sixty_forty.md) | The classic balanced portfolio and why it has been the default for decades |
| 5 | [Bonds - Your Portfolio's Shock Absorber](course/week05_bonds.md) | How bonds work, why they matter, and their role in portfolio stability |
| 6 | [Gold and Commodities as Diversifiers](course/week06_gold_commodities.md) | Why alternative assets reduce portfolio volatility when stocks and bonds move together |
| 7 | [Portfolio Rebalancing](course/week07_rebalancing.md) | The discipline of selling winners and buying losers to maintain your target allocation |
| 8 | [Reading Financial Statements - Basics](course/week08_financial_statements.md) | Income statement, balance sheet, and cash flow - the three lenses into a company |
| 9 | [Understanding Market Indexes](course/week09_market_indexes.md) | How indexes are built, what they measure, and why they drive trillions in flows |
...
| 16 | [Business Cycles and Sector Rotation](course/week16_sector_rotation.md) | Tilting your portfolio based on where we are in the economic cycle |
| 17 | [Performance Metrics - Volatility, Drawdowns, Sharpe](course/week17_performance_metrics.md) | Measuring portfolio quality beyond just returns |
| 18 | [Interest Rates and Market Returns](course/week18_interest_rates.md) | How rates affect every asset class - the most important macro variable |
| 19 | [Corporate Finance - What Makes Companies Tick](course/week19_corporate_finance.md) | Capital structure, dividends, buybacks, and their signals to investors |
| 20 | [Earnings Analysis and Cash Flow](course/week20_earnings_cashflow.md) | Separating real profitability from accounting illusions |
| 21 | [Equity Valuation - P/E, P/B, and DCF](course/week21_equity_valuation.md) | The three fundamental approaches to deciding if a stock is cheap or expensive |
...
| 28 | [Cash-Secured Puts for Entry](course/week28_cash_secured_puts.md) | Getting paid to buy stocks at prices you'd happily pay anyway |
| 29 | [Option Greeks - Delta, Theta, Vega](course/week29_option_greeks.md) | Understanding the forces that move option prices |
| 30 | [Credit Spreads and Iron Condors](course/week30_spreads_condors.md) | Defined-risk strategies for generating income in range-bound markets |
| 31 | [Fixed Income Deep Dive - Yield Curves](course/week31_yield_curves.md) | What the shape of the yield curve tells us about the economy and future rates |
| 32 | [Duration and Convexity](course/week32_duration_convexity.md) | Measuring and managing interest rate risk in bond portfolios |
| 33 | [Credit Analysis and Bond Selection](course/week33_credit_analysis.md) | Evaluating corporate and government credit quality - when spread means risk |
...
| 40 | [Trading the VIX and Volatility](course/week40_vix_volatility.md) | Volatility as an asset class - contango, term structure, and mean reversion |
| 41 | [Risk Management Like a Pro](course/week41_risk_management.md) | Position sizing, stop losses, risk budgets, and the 2% rule |
| 42 | [Portfolio Risk Models - VaR and Beyond](course/week42_var_risk_models.md) | Quantifying tail risk and understanding what can go wrong |
| 43 | [Active Portfolio Management](course/week43_active_management.md) | Alpha, tracking error, information ratio - the math of active investing |
...
- **English**: `course/` (primary)
- **Hong Kong Chinese**: `course_hk/`
- **Taiwan Chinese**: `course_tw/`
- **Mainland Chinese**: `course_cn/`

## Website

A static website at `docs/` serves all course content with a language toggle button (EN/HK/TW/CN). Run the build script to regenerate after editing markdown files.
