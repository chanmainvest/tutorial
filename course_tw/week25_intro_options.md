...
本週的互動實驗室（[course/interactive/week25_option_explorer.html](interactive/week25_option_explorer.html)）讓你選擇四種部位中的任何一種，拖動履約價、到期日、波動率、利率與現貨的滑桿，即時觀察權利金拆解如何更新，同時疊加顯示到期時的損益圖。在閱讀第26週之前，請花二十分鐘在這個工具裡操作。六週的策略教材，全都建立在那五個滑桿上。
